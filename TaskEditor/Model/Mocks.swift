...
struct Mocks {
  ...
  static var mockIdeaList: [Idea] = [
    ...
    Idea(title: "Web Dev Idea", createdDate: .now, modifiedDate: .now, isImportant: false, ideaType: "Web"),
    Idea(title: "App Design Idea", createdDate: .now, modifiedDate: .now, isImportant: false, ideaType: "App"),
    Idea(title: "Web Design Idea", createdDate: .now, modifiedDate: .now, isImportant: true, ideaType: "Web"),
    Idea(title: "App Launching Idea", createdDate: .now, modifiedDate: .now, isImportant: false, ideaType: "App"),
